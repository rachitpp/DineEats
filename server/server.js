...
(async () => {
  try {
    ...
    try {
      ...
      console.error('PostgreSQL connection error - some features may be unavailable:', pgError);
    }
    ...
    if (postgresConnected) {
      ...
      app.use('/api/orders', (req, res) => {
        res.status(503).json({
          message: 'Order functionality is temporarily unavailable. Please try again later.'
        });
      });
    }
